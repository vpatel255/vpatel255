...
class TestDBDA(unittest.TestCase):
    def test_after(self):
        self.assertEqual(after("2023-01-01"), "2023-01-02")
        self.assertEqual(after("2023-12-31"), "2024-01-01")
        self.assertEqual(after("2024-02-28"), "2024-02-29")  # Leap year
        self.assertEqual(after("2024-02-29"), "2024-03-01")  # Leap year

    def test_before(self):
        self.assertEqual(before("2023-01-01"), "2022-12-31")
        self.assertEqual(before("2024-01-01"), "2023-12-31")
        self.assertEqual(before("2024-03-01"), "2024-02-29")  # Leap year
        self.assertEqual(before("2024-02-29"), "2024-02-28")  # Leap year
